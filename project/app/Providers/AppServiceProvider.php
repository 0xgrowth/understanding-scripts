...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view()->composer('*',function($settings){
            ...
            // Added by Segun Great, this is to set default social links has it seems required by all front pages
            $social_links = SocialLinks::orderBy('id','desc')->get();
            $settings->with('sociallinks', $social_links);
